      ...
      <TextContainer>
        ...
        <ul>
          <li>
            ...
            "Us" or "Our" in this Cookies Policy) refers to Patrick Nasralla.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to www.patricknasralla.com (Patrick
            Nasralla).
          </li>{' '}
          <li>
        ...
        <ul>
          <li>By email: patrick.nasralla@gmail.com</li>
        </ul>

        <h4>Last updated: April 08, 2020</h4>
      </TextContainer>
    </PageStyles>
  </Layout>
);
